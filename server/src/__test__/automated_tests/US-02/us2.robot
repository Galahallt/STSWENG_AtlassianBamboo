...
[2-10] User adds Professor with Complete Input
    Set Selenium Speed  1
    Login to PTP
    Input Text  lastName  Chou
    Input Text  firstName   Tzuyu
    Input Text  email   Tzuyu_Chou@dlsu.edu.ph
    Select From List By Index   class:college_select        7
    Select From List By Index   class:department_select        5
    Input Course    COBLAW1
    Input Course    COBLAW2
    Click Button    confirm_addProfessorBtn
