*** Settings ***
Documentation    US # 8 test cases for the Profs to Pick Website
...
...
[8-01] Delete my own review
    Set Selenium Speed  1
    Login to PTP
    Click Element   xpath=//div[@id='app']/div/div/div[2]/div[2]/a/div/div/div
    Click Element   css=.delete-btn
    ...
    Page should not contain     First Comment for Kim Dahyun Prof GEMATMW
    Page should notcontain     Second Comment for Kim Dahyun Prof GEMATMW
